...
import com.languageweaver.sdk.contentinsights.cloud.request.CloudFileContentInsightsRequest;
...
public class CloudContentInsightsService {
    ...
    private static void createContentInsightsForExistingTranslations(CloudLanguageWeaverClient lwClient) throws IOException, InterruptedException {
        ...
        final CloudContentInsightsResult cloudContentInsightsResult = lwClient.getContentInsightsForTranslations(cloudContentInsightsRequest);
        //handle result
    }
}
